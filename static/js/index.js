...
// <-- ADICIONADO: flag para bloquear envio duplicado
let isAguardandoResposta = false;
...
async function enviarMensagem() {
    // <-- ADICIONADO: se já estamos aguardando resposta, não faz nada
    ...
    // <-- ADICIONADO: bloqueia novos envios até finalizar
    isAguardandoResposta = true;
    ...
    try {
        ...
        console.error("Erro ao enviarMensagem:", erro);
        novaBolhaBot.innerHTML = "Erro ao processar sua mensagem.";
    } finally {
        // <-- ADICIONADO: libera o envio para a próxima pergunta
